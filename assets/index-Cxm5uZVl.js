...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:$t,depthTest:!1,depthWrite:!1})}function $a(){return new In({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:jo(),fragmentShader:`
		...
		`,blending:$t,depthTest:!1,depthWrite:!1})}function Za(){return new In({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:jo(),fragmentShader:`
