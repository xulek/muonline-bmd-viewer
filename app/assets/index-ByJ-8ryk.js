...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Lt,depthTest:!1,depthWrite:!1})}function Pm(s,e,t){const n=new Float32Array(Jn),i=new k(0,1,0);return new Tn({name:"SphericalGaussianBlur",defines:{n:Jn,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Mr(),fragmentShader:`
		...
		`,blending:Lt,depthTest:!1,depthWrite:!1})}function Ml(){return new Tn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Mr(),fragmentShader:`
		...
		`,blending:Lt,depthTest:!1,depthWrite:!1})}function Sl(){return new Tn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Mr(),fragmentShader:`
		...
		`,blending:Lt,depthTest:!1,depthWrite:!1})}function Mr(){return`
...
`)+`
`+m);const S=M+f+a,A=M+m+o,R=Pl(i,i.VERTEX_SHADER,S),v=Pl(i,i.FRAGMENT_SHADER,A);i.attachShader(x,R),i.attachShader(x,v),t.index0AttributeName!==void 0?i.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(x,0,"position"),i.linkProgram(x);function E(w){if(s.debug.checkShaderErrors){const P=i.getProgramInfoLog(x)||"",U=i.getShaderInfoLog(R)||"",N=i.getShaderInfoLog(v)||"",F=P.trim(),V=U.trim(),q=N.trim();let G=!0,Q=!0;if(i.getProgramParameter(x,i.LINK_STATUS)===!1)if(G=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,x,R,v);else{const te=Dl(i,R,"vertex"),ge=Dl(i,v,"fragment");Ve("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(x,i.VALIDATE_STATUS)+`
